...
def parse_args():
    parser = argparse.ArgumentParser(
        prog="Movie Recommender", description="Run ALS Movie Recommender")
    ...
    parser.add_argument('--movie_name', nargs='?', default='', help='provide your favoriate movie name')
...
if __name__ == '__main__':
    ...
    print("Time taken to print the recommendations ")
    print(b - a)
    spark.stop()